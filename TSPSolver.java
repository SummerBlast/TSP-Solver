...
public class TSPSolver extends JFrame {
    ...
    private JButton solveTSP;
    private JButton hideorshownoedges;
    ...
    public TSPSolver() {
        setTitle("Travelling Salesmen Problem Solver");
        setSize(1000, 600);
            ...
            public void mouseClicked(MouseEvent e) {
                if (addVertexButton.isSelected()) {
                    ...
                    if (vertex1 == null) {
                        ...
                        if (foundVertex2) {
                            String weightStr = JOptionPane.showInputDialog(TSPSolver.this,
        ...
        solveTSP.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
        ...
        hideorshownoedges.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
